...
class ChartDownScreen extends Component{
    constructor(props){
        super(props);
    }
        ...
        return(
            <View style={styles.contain}>
                <View style={styles.contain_view_header_list}>
                    <Text style={styles.contain_view_header_list_text}>{this.props.list_calculate_down.length}</Text>
                </View>
                <FlatList
                    style={styles.contain_list}
                    data = {this.props.list_calculate_down}
                    renderItem={({item}) => (
...
function mapStateToProps(state){
    return{
        list_calculate_down: state.KC.list_calculate_down,
...
export default connect(mapStateToProps, mapDispatchToProps)(ChartDownScreen);