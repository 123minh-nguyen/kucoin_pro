...
class ChartUpScreen extends Component{
    constructor(props){
        super(props);
    }
        ...
        return(
            <View style={styles.contain}>
                <View style={styles.contain_view_header_list}>
                    <Text style={styles.contain_view_header_list_text}>{this.props.list_calculate_up.length}</Text>
                </View>
                <FlatList
                    style={styles.contain_list}
                    data = {this.props.list_calculate_up}
                    renderItem={({item}) => (
...
function mapStateToProps(state){
    return{
        list_calculate_up: state.KC.list_calculate_up,
...
export default connect(mapStateToProps, mapDispatchToProps)(ChartUpScreen);